    ...
    client.channels
      ...
      .send(
        new Discord.MessageEmbed()
          .setTitle(`RotaCraft Destek Talebi`)
          .setFooter(`RotaCore • Bu Bot UrfaKebab.yml#1868 Tarafından Yapılmıştır.`, client.user.avatarURL)
          .setColor("#84ff00")
       .setThumbnail("https://media.discordapp.net/attachments/789194895931211838/799305620029177856/rotacraft_kopya-2.png?width=476&height=411")
          .setDescription(`📩 tepkisine tıklayıp bir destek talebi oluşturabilirsiniz.`)
      )
      .then(m => {
        m.react("📩");
